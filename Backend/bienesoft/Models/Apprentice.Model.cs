...
namespace bienesoft.Models
{
    public class Apprentice
    {
        ...
        [DisplayName("Apellido del Aprendiz")]
        [Required(ErrorMessage = "Campo {0} es requerido")]
        [StringLength(45, ErrorMessage = "El campo {0} tiene un limite de caracteres de {1}")]
        public string Apprentice_Surname { get; set; }
        ...
        public int? Acumulated_Permissions { get; set; } = null;

        [DisplayName("Estado de Aprendiz")]
        public bool state_Apprentice { get; set; }

        [DisplayName("Contraseña ")]
        public string Apprentice_Password { get; set; }
    }
}
